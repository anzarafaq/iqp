...
function drawTable(sortby) //initially data comes from category main chart ajax source, use the same one to create table
{
    ...
    flextable = 
    {
        colModel : [
                        ...
                        {display: 'Scenarios', name : 'Scenarios',abbr : 'Scenarios',width : 210, /* sortable : true,*/ align: 'center'},
                        {display: 'Issues', name : 'Issues',abbr : 'Issues',width : 210, /* sortable : true ,*/ align: 'center'}
                ],
        resizable: false,
        width: 668,
        height: 'auto',
